                    ...
                    <li class="treeview <?php echo set_Topmenu('System Settings'); ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <?php } if ($this->rbac->hasPrivilege('system_fields', 'can_view')) {
                                ...
                                if ($this->rbac->hasPrivilege('superadmin')) {
                                    ?>
                                <li class="<?php echo set_Submenu('System Settings/updater'); ?>"><a href="https://fb.me/AbrahamYusuf1105" target="blank"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('system_update') ?></a></li>
                        <?php
                    }
                    ?> 
