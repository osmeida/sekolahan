                                            ...
                                            <div class="paddtop20">
                                                <div class="padd2 paddtzero">
                                                    <table class="table2" width="100%">
                                                        <tr>
                                                            <th width="50%"><?php echo ('Decription'); ?></th>
                                                            <th width="50%"><?php echo ('Amount') ?></th>
                                                        </tr>
                                                        <tr>
                                                            <td><?php
                                                                echo $params['payment_detail']->fee_group_name . "<br/><span>" . $params['payment_detail']->code;
                                                                ?></td>
                                                            <td><?php echo $setting[0]['currency_symbol'] . $params['total']; ?></td>
                                                        </tr>

                                                        <tr class="bordertoplightgray">
                                                            <td bgcolor="#fff"><?php echo ('Total'); ?>:</td>
                                                            <td bgcolor="#fff"><?php echo $setting[0]['currency_symbol'] . $params['total']; ?></td>
                                                        </tr>
                                                        <tr><td colspan="2"><hr /></td></tr>
                                                        <tr class="bordertoplightgray">
                                                            <td bgcolor="#fff">  </td>
                                                            <td bgcolor="#fff"><button type="button"  name="search" id="pay-button"  value="" class="btn btn-info"><i class="fa fa fa-chevron-right"></i> <?php echo ('Pay With Midtrans'); ?></button>  </td>
                                                        </tr>
                                                    </table>
